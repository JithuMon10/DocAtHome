...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=24&pause=1000&color=00FFCC&center=true&vCenter=true&width=500&lines=Secure+HD+Video+Calls;Real-Time+Doctor+Chat;WebRTC+Peer-to-Peer;Healthcare+Simplified" alt="Animated Typing" />
</p>
...
### 🏥 For Patients
* **Easy Booking:** Streamlined appointment form with a demo payment gateway.
...
4. **Launch:** Open your browser and visit `http://localhost/DocAtHome/`.
...
## 🤝 Connect
**Jithendra V Anand** *Cyber Security & Full-Stack Developer* [LinkedIn Profile](https://www.linkedin.com/in/jithu2006/)
