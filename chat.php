...
<head>
  ...
  <title>Patient Chat - DocAtHome</title>
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.0/font/bootstrap-icons.css">
  <style>
    :root {
        --patient-primary: #00d2ff;
        --patient-primary-gradient: linear-gradient(135deg, #00d2ff 0%, #3a7bd5 100%);
        --patient-bg: #0093E9;
        --patient-bubble-bg: #e3f8ff;
    }
    html, body {
        height: 100%;
        overflow: hidden;
    ...
    .chat-header {
      background: var(--patient-primary-gradient);
      color: white;
      padding: 20px 25px;
      font-weight: 700;
      font-size: 1.3em;
  ...
  <script>
      ...
      fetch('get_messages.php?booking_id='+bid+'&since='+offset)
        ...
        .then(data=>{
          ...
          (data.messages||[]).forEach(m=>{
            ...
            div.className = m.sender === 'patient' ? 'msg msg-patient' : 'msg msg-doctor';
    ...
    function sendMessage(){
      ...
      if(!message){return;}
      fetch('send_message.php', { method:'POST', headers:{'Content-Type':'application/x-www-form-urlencoded'}, body:'booking_id='+encodeURIComponent(bid)+'&sender=patient&message='+encodeURIComponent(message) })
        .then(r=>r.json())
...
<div class="chat-container" style="margin: 10px auto;">
  <div class="chat-header">
    <div class="d-flex justify-content-between align-items-center">
        <span>Patient Chat - Booking #<?php echo htmlspecialchars((string)$bookingId); ?></span>
