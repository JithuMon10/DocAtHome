...
<head>
  ...
  <style>
    :root {
        ...
        [REDACTED]: linear-gradient(135deg, #00d2ff 0%, #3a7bd5 100%);
        --patient-bg: #0093E9;
  ...
  <script>
    ...
    function sendMessage(){
      ...
      if(!message){return;}
      fetch('send_message.php', { method:'POST', headers:{'Content-Type':'application/[REDACTED]}, body:'booking_id='+encodeURIComponent(bid)+'&sender=patient&message='+encodeURIComponent(message) })
        .then(r=>r.json())
